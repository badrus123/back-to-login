...
<nav class="navbar navbar-expand-lg navbar-light header fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav ">
      ...
      <li class="nav-item active">
        <a class="nav-link text-white" href="profile.php"><!-- isi session name --><span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <h3><!-- isi session name --></h3>
                    <p><!-- isi session email --></p>
            ...
            <div class="card mb-3">
                <div class="container"> 
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" data-toggle="modal" href="" data-target="#myModal<!-- isi sesuai ID database dengan di looping -->"data-toggle="modal" data-target="#myModal">Edit</a>
                            <?php echo " <a class='dropdown-item' href='delete.php?id=$user_data[id_posting]'>Delete</a></td></tr>" ?>
                        </div>
                </div>       
                <div class="card-body">
                    <div class="mt-3 ml-3 row ">    
                        <img class="img img-responsive rounded-circle mb-3" width="50" src="img/<!-- isi session image -->" />
                        <h4 class="ml-2 card-title"><!-- isi session name --></h4>
                    </div>
                    <!-- isi session Postingan -->
                </div>
            </div>

                    <!-- The Modal -->
            <div class="modal" id="myModal<!-- isi sesuai id looping dari postingan -->">
                ...
                <div class="modal-content">
                    ...
                    <form action="edit.php?id=<!-- isi id posting dari database -->" method="POST" >
                            <div class="form-group">
                                <textarea  name="data" class="form-control" placeholder="Apa yang kamu pikirkan?" required></textarea>
